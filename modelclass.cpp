...
bool ModelClass::InitializeTorus(ID3D11Device* device)
{
	GeometricPrimitive::CreateTorus(preFabVertices, preFabIndices, 1, 8, false);
	m_vertexCount = preFabVertices.size();
	m_indexCount = preFabIndices.size();
...
//bool ModelClass::InitializeCustom(ID3D11DeviceContext* device) {
//	//VertexCollection vertices;
//	GeometricPrimitive::CreateBox(preFabVertices, preFabIndices,
//		XMFLOAT3(1.f / 2.f, 2.f / 2.f, 3.f / 2.f));
//
//	// Tile the texture in a 5x5 grid
//	for (auto& it : preFabVertices)
//	{
//		it.textureCoordinate.x *= 5.f;
//		it.textureCoordinate.y *= 5.f;
//	}
//
//	// GeometricPrimitive::CreateCustom(device, preFabIndices, preFabVertices );
//}
